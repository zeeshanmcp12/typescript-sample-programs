...
console.log("Sorry ".concat(guestList.pop(), ", you will be our guest next time!\n"));
console.log("Sorry ".concat(guestList.pop(), ", you will be our guest next time!\n"));
console.log("Sorry ".concat(guestList.pop(), ", you will be our guest next time!\n"));
console.log("Sorry ".concat(guestList.pop(), ", you will be our guest next time!\n"));
console.log("Out guests ".concat(guestList, " are still invited in the event.\n"));
console.log("::DEBUG: ".concat(guestList.pop(), " removed from the list"));
console.log("::DEBUG: ".concat(guestList.pop(), " removed from the list"));
console.log("::DEBUG: ".concat(guestList, "List is empty!"));
console.log(guestList);
